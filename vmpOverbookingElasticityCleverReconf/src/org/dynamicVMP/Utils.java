...
public class Utils {
    ...
    public static List<APrioriValue> getAprioriValuesList(Integer timeUnit){
        ...
        aPrioriValuesList.add(new APrioriValue(ObjectivesFunctions.MIN_POWER,DynamicVMP.MAX_POWER));
        aPrioriValuesList.add(new APrioriValue(ObjectivesFunctions.MIN_REVENUE,DynamicVMP.REVENUE_APRIORI_TIME.get(timeUnit)));
        aPrioriValuesList.add(new APrioriValue(0F,1F));
        aPrioriValuesList.add(new APrioriValue(0F,DynamicVMP.MIGRATED_MEMORY_APRIORI_TIME.get(timeUnit)));
